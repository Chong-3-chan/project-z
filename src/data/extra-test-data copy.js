...
// export const resource_base_path = "https://121.4.55.200/resource/extra_test_active/";
...
function getBook() {
    ...
    return function _Book(book_line, story_line) {
        story_line.forEach(s => Story(s));
        return { Book: Book(book_line), STORY, SENTENCE }
    }
};
const te = getBook();
// console.log(te(b, s_));

export const BOOK = { data: { Book1: te(b, s_).Book } };
// export const BOOK = {
//     data: {
//         Book1: {
//             start: "0_0",
