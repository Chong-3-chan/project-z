...
>tips=lxy,mes
~0:
@?##「Hello world」##chara[12,00,a_2]##setPlace[_P_INDOOR_5]
...
// export const BOOK = { data: { Book1: textToBOOK(b["Book1"], s["Book1"]).Book } };
// export const BOOK = {
//     data: {
//         Book1: {
//             start: "0_0",
    ...
    for (let line of lines) {
        ...
        switch (line[0]) {
            ...
            case ">": // 如果是>，表示文件的追加属性
                ...
                if (key == "end") value = value.split(",").map(e => e.trim())
                obj[key] = value;
                break;
